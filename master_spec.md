...
Legacy underscore duplicate retained for old references. Do not frontload this file. Use `MasterSpec.md` first, then `master-spec.md` for the full product/source spec.
